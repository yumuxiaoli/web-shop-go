module github.com/yumuxiaoli/web-shop-go/cartApi
...
require (
	...
	github.com/yumuxiaoli/common v0.0.0-20231007092034-4886c4b528af // indirect
	github.com/yumuxiaoli/web-shop-go/cart v0.0.0-20231008115336-009173a28b61 // indirect
