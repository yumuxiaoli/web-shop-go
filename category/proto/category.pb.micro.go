...
type CategoryService interface {
	...
	FindCategoryByName(ctx context.Context, in *FindByNameRequset, opts ...client.CallOption) (*CategoryResponse, error)
...
func (c *categoryService) FindCategoryByName(ctx context.Context, in *FindByNameRequset, opts ...client.CallOption) (*CategoryResponse, error) {
...
type CategoryHandler interface {
	...
	FindCategoryByName(context.Context, *FindByNameRequset, *CategoryResponse) error
...
func RegisterCategoryHandler(s server.Server, hdlr CategoryHandler, opts ...server.HandlerOption) error {
	type category interface {
		...
		FindCategoryByName(ctx context.Context, in *FindByNameRequset, out *CategoryResponse) error
...
func (h *categoryHandler) FindCategoryByName(ctx context.Context, in *FindByNameRequset, out *CategoryResponse) error {
